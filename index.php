	...
	<body>
				...
				<div class="row">
					<div class="col-md-12">
						<nav class="navbar navbar-expand-lg ">
							<a class="navbar-brand cus-a" href="index.php">Hillary's Law Firm Lawyer Management System</a>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 ml-auto">
						<h1>About US</h1>
						<p>Welcome to Hillary's Law Firm</p>
						<h2>Our Contact details </h2>
						<h4>Address - hillarymosongo450@gmail.com</h4>
						<h4>Contact no. - 0795146125</h4>
					</div>
					<div class="col-md-6">
		...
		<footer class="bg-success">
			<div class="container">
				<div class="row">
					<div class="col">
						<h5>All rights reserved. FellohTech 2023</h5>
					</div>
				</div>
			</div>
		</footer>
